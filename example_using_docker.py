...
# Rendu
scene.render(str(output_folder.joinpath("earth_render.png")), width=80, height=60, tempfile='temp.pov', docker=True, resources_folder="C:\\Users\\Arnaud Somville\\.sbtig\\resources\\")
